...
public class ShortenerController {
    ...
    /**
     * Essa classe define um controlador REST para gerenciar URLs encurtadas.
     * Ela possui dois endpoints principais:
     * @GetMapping("/{shortCode}") → Recupera a URL original a partir do código encurtado.
     * @PostMapping → Recebe uma URL e retorna um código encurtado.
     * O serviço ShortenerService é injetado no controlador e utilizado para buscar e encurtar URLs.
     * Os logs (System.out.println) ajudam a depurar os valores retornados.
     */
}